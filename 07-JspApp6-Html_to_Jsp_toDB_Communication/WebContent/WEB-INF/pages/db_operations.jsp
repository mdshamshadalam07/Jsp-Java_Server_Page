...
private ResultSet rs;
   public void jspInit(){
	try{
     ...
     ps1=con.prepareStatement("INSERT INTO PRODUCT VALUES(PRODUCTID_SEQ1.NEXTVAL,?,?,?)");
  ...
  //for link
     if(pval.equalsIgnoreCase("link")){
    	 //execute  select query that is made as pre-compiled SQL Query
    	  rs=ps2.executeQuery(); %>
    	  <h1 style="color:red;text-align:left"> All List of Products  </h1>
  ...
  <%  		 
    	...
    	<% }//else 
         ...
         %>
      <br><br>
      <h2><center><a href ='register.html'><img src ='home.jpg' width='40' height='40'></a></center></h2>   
